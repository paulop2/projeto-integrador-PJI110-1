...
```
  ...
  <verify>
    <automated>cd /Users/pvs/projetos/projeto-integrador-PJI110-1/frontend && npx tsc --noEmit 2>&1 | grep "AlunosPage\|DisciplinasPage" | head -10</automated>
  </verify>
  ...
  <done>AlunosPage: paginated list with Nome/Matrícula/Turma/Status columns, create/edit modal with react-hook-form + zod, deactivation confirmation dialog, toast feedback. DisciplinasPage: paginated list, create/edit modal.</done>
</task>
